...
{{--second--}}
	...
	'header-normal style2' }} @if(session('website_locale',app()->getLocale()) == 'egy') is-rtl @endif">
		<div class="container-fluid p0">
		    ...
		    <nav>
				...
				<a href="{{ url(app_get_locale(false,'/')) }}" class="navbar_brand float-left dn-smd" style="width: 180px">
				...
				<div class="main_logo_home2 text-center" onclick="window.location.href='{{asset('/')}}'">
					{{-- <a href="{{asset('/')}}" class="navbar_brand float-left dn-smd"> --}}
						@if($logo_id = setting_item("logo_id_mb"))
							<?php $logo = get_file_url($logo_id,'full') ?>
							<img class="nav_logo_img mt20" src="{{$logo}}" alt="{{setting_item("site_title")}}">
