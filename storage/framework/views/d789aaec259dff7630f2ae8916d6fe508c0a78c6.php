...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <?php $__currentLoopData = $all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
            <div class="panel">
                <div class="panel-title cursor-pointer" data-toggle="collapse" href="#gateway_<?php echo e($k); ?>">
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\misr\themes/Findhouse/Booking/Views/admin/settings/payment.blade.php ENDPATH**/ ?>