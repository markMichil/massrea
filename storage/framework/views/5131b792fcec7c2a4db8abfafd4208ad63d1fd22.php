...
<body class="user-page bgc-f7 <?php echo e($body_class ?? ''); ?> <?php if(session('website_locale',app()->getLocale()) == 'egy'): ?> is-rtl <?php endif; ?>">
                            ...
                            <div class="row mt10 d-none">
                                <div class="col-lg-12">
                                    <div class="copyright-widget text-center">
                                        <p><?php echo e(__('© 2020 Misrrea. Made with love.')); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\misr\themes/Findhouse/Layout/user.blade.php ENDPATH**/ ?>